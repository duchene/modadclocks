...
compile.results <- function(branch.results){
	...
	allres <- list(empirical_branch_lengths = bls[[1]], pps_branch_lengths = bls[[2]], branch_length_pvalues = pvals, overall_pval = fullpval, empirical_multlik = bls[[3]], pps_multliks = bls[[4]], mlik_pvalue = mlik_pvalue, pps_blen_range = meandifran1, pps_blen_range_CI = meandifran2)
	return(allres)
